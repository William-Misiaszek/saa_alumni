...
const OpenSearchModalButton = (props) => (
  <Button
    ...
    className={{
      ...
      "search-button su-w-40 su-h-40 su-ml-auto su-items-center su-justify-content-center lg:su-w-auto lg:su-h-auto lg:su-pl-16 lg:su-pr-13 lg:su-pt-2 su-rounded-full lg:su-text-18 su-leading-none su-border-2 su-border-solid su-border-digital-red-xlight su-transition-colors hocus:su-bg-cardinal-red-xxdark xl:hocus:su-bg-cardinal-red-xdark lg:hocus:su-no-underline": true,
    }}
    variant="unset"
    size="minimal"
