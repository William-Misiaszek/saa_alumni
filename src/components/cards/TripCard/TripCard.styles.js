export const root =
  'su-group su-relative su-overflow-hidden su-bg-black-true su-break-words su-border-black sm:su-max-w-[42rem] md:su-max-w-full';
...
export const link =
  'su-stretched-link su-group su-z-20 su-mb-08em su-type-2 xl:su-text-m3 su-no-underline hocus:su-underline su-underline-offset !su-underline-thick !su-underline-digital-red-xlight';
...
export const subheading = 'su-mt-4 su-mb-0 su-font-semibold su-text-white';
