...
const WidthBox = ({ width, className, children, ...props}) => {
  ...
  if (width === '6') {
    columnSpan = 'su-col-span-12 md:su-col-span-10 md:su-col-start-2 lg:su-col-span-8 lg:su-col-start-3 xl:su-col-span-6 xl:su-col-start-4';
  }
  else if (width === '8') {
    columnSpan = 'su-col-span-12 lg:su-col-span-10 lg:su-col-start-2 xl:su-col-span-8 xl:su-col-start-3';
  }
  else if (width === '10') {
