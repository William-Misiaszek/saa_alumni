  ...
  trips.forEach((trip) => {
    ...
    if (trip?.content?.tripDeposit) {
      ...
      data.push([
        ...
        'Traveler',
        'TRUE',
        'Note: First person added (traveling or not) receives payment summary (showing names of registrants and amount of each deposit). Subsequent people receive confirmation email only.',
        'Traveler',
        'TRUE',
        'USD',
        `${dollarValue}00`,
